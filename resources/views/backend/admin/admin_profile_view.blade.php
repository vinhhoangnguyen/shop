    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <form id="profile_form" action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $admin_Data->name }}">
                                        </div>
                                        @error('name')
                            ...
                            <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ $admin_Data->email }}">
                                        </div>
                                        @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $admin_Data->phone}}">
                                        </div>
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="address" id="address" class="form-control" value="{{ $admin_Data->address }}">
                                        </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <img id="showImage" src="{{ (isset($admin_Data->photo)) ? asset($admin_Data->photo) : asset('backend/upload/no_image.jpg')  }}" class="rounded-circle avatar-lg img-thumbnail"
                        alt="profile-image">
                                </div>
                            </div>
