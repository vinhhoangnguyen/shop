                            ...
                            <div class="header-action-icon-2">
                                ...
                                @auth
                                    ...
                                    <a href="{{ route('customer.dashboard')}}">
                                        <img class="svgInject" alt="Khách hàng" src=" {{ asset('frontend/assets/imgs/theme/icons/icon-user.svg') }}" />
                                    </a>
                                    <a href="{{ route('customer.dashboard')}}"><span class="lable ml-0">{{ Auth::user()->name }}</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>

                                            <li>
                                                <a href="{{ route('customer.dashboard')}}"><i class="fi fi-rs-settings-sliders mr-10"></i>Bảng điều khiển</a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fi fi-rs-label mr-10"></i>Phiếu giảm giá</a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fi fi-rs-heart mr-10"></i>Yêu thích</a>
                                            </li>
                                ...
                                @else
                                    ...
                                    <a href="{{ route('register') }}">
                                        ...
                                        <span class="lable ml-0 ">Đăng ký</span>
                                    </a>
                                    <span class="lable" style="margin-left: 2px, margin-right: 2px">|</span>

                                    <a href="{{ route('login') }}"><span class="lable">Đăng nhập</span></a>
