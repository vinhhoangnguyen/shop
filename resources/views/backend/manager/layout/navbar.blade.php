        ...
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src=" {{ (!empty(Auth::user()->photo))? asset(Auth::user()->photo) : asset('backend/upload/no_image.jpg')  }}" alt="user-image" class="rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                        <span>Chức năng: <strong>{{ Auth::user()->role}}</strong></span>
                    </a>
                    ...
                    <!-- item-->
                    <a href="{{ route('manager.password.change') }}" class="dropdown-item notify-item">
                        <i class="fe-settings"></i>
                        <span>Mật khẩu</span>
                    </a>

                    <!-- item-->
                    <a href="{{ route('manager.lock') }}" class="dropdown-item notify-item">
                        <i class="fe-lock"></i>
                    ...
                    <div class="dropdown-divider"></div>
                     <!-- item-->
                     <a href="{{ route('manager.logout') }}" class="dropdown-item notify-item">
