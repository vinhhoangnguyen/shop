...
<div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4">
                            <div class="text-lg-end">
                                ...
                                <button type="button" class="btn btn-light waves-effect mb-2" data-bs-toggle="modal" data-bs-target="#viewExportModal"> <i class="mdi mdi-arrow-collapse-down"></i> Nhập</button>
   ...
   {{-- <livewire:category.create-category /> --}}
            ...
            <div wire:ignore.self class="modal fade" id="viewExportModal" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true" >
                            ...
                            <div class="modal-body">
                                <div class="uploadFileImport">
                                    <div class="input-group">
                                        <input wire:model="fileViewImport" type="file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                        <button wire:click="uploadFileView" class="btn btn-outline-secondary" id="inputGroupFileAddon04">Tải lên</button>
